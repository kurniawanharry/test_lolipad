...
class _$_SubdistrictModel implements _SubdistrictModel {
  ...
  @override
  String toString() {
    return 'SubdistrictModel(data: $data, message: $message, status: $status, statusCode: $statusCode, timestamp: $timestamp)';
  }
...
abstract class _SubdistrictModel implements SubdistrictModel {
  const factory _SubdistrictModel(
      ...
      String? status,
      int? statusCode,
      DateTime? timestamp}) = _$_SubdistrictModel;
...
class _$DatumTearOff {
  ...
  _Datum call(
      {String? postalCode, String? subDistrictId, String? subDistrictName}) {
    return _Datum(
...
class _$_Datum implements _Datum {
  const _$_Datum({this.postalCode, this.subDistrictId, this.subDistrictName});
  ...
  @override
  String toString() {
    return 'Datum(postalCode: $postalCode, subDistrictId: $subDistrictId, subDistrictName: $subDistrictName)';
  }
